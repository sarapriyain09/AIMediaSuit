...
export async function DELETE(request: NextRequest, { params }: Params) {
  ...
  try {
    const found = await prisma.presentationGeneration.findFirst({
      where: {
        id,
        userId,
      },
    ...
    await prisma.presentationGeneration.delete({ where: { id } });
...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const updated = await prisma.presentationGeneration.update({
      where: { id },
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const source = await prisma.presentationGeneration.findFirst({
      where: { id, userId },
    });
    ...
    const duplicated = await prisma.presentationGeneration.create({
      data: {
        userId,
